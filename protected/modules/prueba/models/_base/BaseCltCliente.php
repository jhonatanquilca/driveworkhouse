...
/**
 * This is the model base class for the table "clt_cliente".
 * DO NOT MODIFY THIS FILE! It is automatically generated by AweCrud.
 * If any changes are necessary, you must set or override the required
 * property or method in class "CltCliente".
 *
 * Columns in table "clt_cliente" available as properties of the model,
 * followed by relations of table "clt_cliente" available as properties of the model.
 *
 * @property integer $id
 ...
 *
 * @property CltDeuda[] $cltDeudas
 */
abstract class BaseCltCliente extends AweActiveRecord {
    ...
    public function relations() {
        return array(
            'cltDeudas' => array(self::HAS_MANY, 'CltDeuda', 'clt_cliente_id'),
        );
    }
