...
$this->menu=array(
//array('label' => Yii::t('AweCrud.app', 'List') . ' ' . CltDeuda::label(2), 'icon' => 'fa fa-list', 'url' => array('index')),
array('label' => Yii::t('AweCrud.app', 'Create') . ' ' . CltDeuda::label(), 'icon' => 'fa fa-plus', 'url' => array('create')),
    ...
    <div class="bs-component p10">
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <span class="panel-title"><?php echo Yii::t('AweCrud.app', 'View') . ' ' . CltDeuda::label(); ?> <?php echo CHtml::encode($model) ?>                </span>
