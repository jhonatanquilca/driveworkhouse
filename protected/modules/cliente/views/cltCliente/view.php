...
array('label' => Yii::t('AweCrud.app', 'Create') . ' ' . CltCliente::label(), 'icon' => 'fa fa-plus', 'url' => array('create')),
    ...
    <div class="bs-component p10">
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <span class="panel-title"><?php echo Yii::t('AweCrud.app', 'View') . ' ' . CltCliente::label(); ?> <?php echo CHtml::encode($model) ?>                </span>
