        ...
        <div class="bs-component p10"> 
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <span class="panel-title"> <?php echo ucwords(CrugeTranslator::t("roles")); ?></span>
                    ...
                    <div class="panel-body p25">
                        <div class="panel-menu">
                            <div class="chart-legend">
                                <?php
                                echo CHtml::link('<i class="fa fa-plus "></i> ' . CrugeTranslator::t("Crear Nuevo Rol")
                                        , Yii::app()->user->ui->getRbacAuthItemCreateUrl(CAuthItem::TYPE_ROLE), array('class' => 'legend-item btn btn-sm btn-success ph20 mr10'));
                                ?>
                            </div>
                        </div>
