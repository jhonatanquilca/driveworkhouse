...
class DeudaController extends AweController {
...
//                $this->redirect(array('view', 'id' => $model->id));
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('Deuda');
    ...
    protected function performAjaxValidation($model, $form = null) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'deuda-form') {
