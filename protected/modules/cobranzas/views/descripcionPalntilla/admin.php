...
$this->menu = array(
    array('label' => Yii::t('AweCrud.app', 'List') . ' ' . DescripcionPalntilla::label(2), 'icon' => 'fa fa-list', 'url' => array('index'), 'htmlOptions' => array('class' => 'btn-default'),),
    array('label' => Yii::t('AweCrud.app', 'Create') . ' ' . DescripcionPalntilla::label(), 'icon' => 'fa fa-plus', 'url' => array('create'), 'htmlOptions' => array('class' => 'btn-default'),),
);
...
$.fn.yiiGridView.update('descripcion-palntilla-grid', {
data: $(this).serialize()
});
return false;
});
    ...
    <div class="bs-component p10">
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <span class="panel-title">     <?php echo Yii::t('AweCrud.app', 'Manage') ?> <?php echo DescripcionPalntilla::label(2) ?>                </span>
