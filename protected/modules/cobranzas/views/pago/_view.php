...
<div class="view">
        ...
        <?php if (!empty($data->usuario_actualizacion)): ?>
        <div class="field">
            <div class="field_name">
        ...
        <?php if (!empty($data->obserbaciones)): ?>
        <div class="field">
            <div class="field_name">
                <b><?php echo CHtml::encode($data->getAttributeLabel('obserbaciones')); ?>:</b>
            </div>
            <div class="field_value">
                <?php echo CHtml::encode($data->obserbaciones); ?>
            </div>
        </div>
