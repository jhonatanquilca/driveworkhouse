...
class Menu {
    ...
    public static function getMenu($controller) {
        ...
        $items = array(
            array('label' => '<span class="fa fa-calendar"></span><span class="sidebar-title">Dashboard</span><span class="sidebar-title-tray"><span class="label label-xs bg-primary">New</span></span>',
                'url' => Yii::app()->homeUrl,
                'access' => 'action_dashboard_index',
                'active_rules' => array('module' => 'principal', 'controller' => 'dashboard')
            ),
            array('label' => '<span class="fa fa-calendar"></span><span class="sidebar-title">Usuarios',
            ...
            array('label' => '<span class="fa fa-calendar"></span><span class="sidebar-title">Final</span><span class="caret"></span>', 'url' => '#',
                'itemOptions' => array('class' => 'dropdown-list'),
                'linkOptions' => array('class' => 'accordion-toggle'),
                'items' => array(
                    array('label' => '<span class="glyphicon glyphicon-book"></span>Paìs', 'url' => array('/personal/pais/admin/'), 'access' => 'action_pais_admin', 'active_rules' => array('module' => 'personal', 'controller' => 'pais')),
